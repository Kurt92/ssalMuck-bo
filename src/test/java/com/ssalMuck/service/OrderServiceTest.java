...
import com.ssalMuck.Entity.Item.Book;
import com.ssalMuck.Entity.Item.Item;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("someting like book", 10000, 10);
    ...
    public void 상품주문_재고수량초과 () throws Exception {
        //given
        Member member = createMember();
        Item item = createBook("someting like book", 10000, 10);
    ...
    public void 주문취소() throws Exception {
        //given
        Member member = createMember();
        Book item = createBook("aaaa", 10000, 10);
